...
class UserFCMDeviceAddTestCase(APITestCase):
    ...
    def test_add_user_fcm_device_ios(self):
        ...
        url = "/modules/firebase_push_notifications/user_fcm_device_add/"
        data = {
...
class NotificationTestCase(APITestCase):
    ...
    def test_create_notification(self):
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.user_token.key)
        url = "/modules/firebase_push_notifications/notification/"
        image = BytesIO()
...
class UserNotificationTestCase(APITestCase):
    ...
    def test_create_user_notification(self):
        ...
        user_notification_url = (
            "/modules/firebase_push_notifications/user-notification/"
        )
